...
##
relf <- relief(sun_a ~ team_a_nr + team_b_nr + spieltag + saison_weight + place_a + place_b + points_a + points_b + hg_01 + wins_pro_a + wins_pro_b + points_pro_a + points_pro_b + wins_a + tied_a + loses_a + wins_b + tied_b + loses_b, data = traindata)
