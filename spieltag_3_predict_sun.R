...
spieltag <- data.frame(readHTMLTable(doc = "http://www.bulibox.de/statistik/bundesliga-ergebnisse.php?liga=1&spieltag=3"))[, 2:3]
table <- data.frame(readHTMLTable(doc = "http://www.bulibox.de/tabelle/dynamische-bundesligatabelle.php?ab=1&bis=2&liga=1&Abfrage=OK"), stringsAsFactors=FALSE)[, 1:6]
